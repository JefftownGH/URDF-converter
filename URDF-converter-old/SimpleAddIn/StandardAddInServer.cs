...
namespace URDFConverter
{
    ...
    public class AddInServer : Inventor.ApplicationAddInServer
    {
        ...
        public void Activate(Inventor.ApplicationAddInSite addInSiteObject, bool firstTime)
        {
            try
            {
                ...
                m_slotWidthComboBoxDefinition = m_inventorApplication.CommandManager.ControlDefinitions.AddComboBoxDefinition("Slot Width", "Autodesk:URDFConverter:SlotWidthCboBox", CommandTypesEnum.kShapeEditCmdType, 100, addInCLSIDString, "Slot width", "Slot width", Type.Missing, Type.Missing, ButtonDisplayEnum.kDisplayTextInLearningMode);
                m_slotHeightComboBoxDefinition = m_inventorApplication.CommandManager.ControlDefinitions.AddComboBoxDefinition("Slot Height", "Autodesk:URDFConverter:SlotHeightCboBox", CommandTypesEnum.kShapeEditCmdType, 100, addInCLSIDString, "Slot height", "Slot height", Type.Missing, Type.Missing, ButtonDisplayEnum.kDisplayTextInLearningMode);

                //add some initial items to the comboboxes
                m_slotWidthComboBoxDefinition.AddItem("_description", 0);
                m_slotWidthComboBoxDefinition.ListIndex = 1;
                m_slotWidthComboBoxDefinition.ToolTipText = m_slotWidthComboBoxDefinition.Text;
                m_slotWidthComboBoxDefinition.DescriptionText = "Description package name (ie. \"rrbot_description\"): " + m_slotWidthComboBoxDefinition.Text;
                ...
                m_addSlotOptionButton = new AddSlotOptionButton(
                    "Add Slot width/height", "Autodesk:URDFConverter:AddSlotOptionCmdBtn", CommandTypesEnum.kShapeEditCmdType,
                ...
                m_drawSlotButton = new DrawSlotButton(
                    "Draw Slot", "Autodesk:URDFConverter:DrawSlotCmdBtn", CommandTypesEnum.kShapeEditCmdType,
                ...
                m_toggleSlotStateButton = new ToggleSlotStateButton(
                    "Toggle Slot State", "Autodesk:URDFConverter:ToggleSlotStateCmdBtn", CommandTypesEnum.kShapeEditCmdType,
                ...
                CommandCategory slotCmdCategory = m_inventorApplication.CommandManager.CommandCategories.Add("Slot", "Autodesk:URDFConverter:SlotCmdCat", addInCLSIDString);
 ...
 //               {
                    ...
                    //DockableWindow ost = userInterfaceManager.DockableWindows.Add("{DB59D9A7-EE4C-434A-BB5A-F93E8866E872}", "URDFconverter", "URDF converter");
                    //ost.AddChild(box.Handle);
                    ...
                    //    slotCommandBar = userInterfaceManager.CommandBars.Add("Slot", "Autodesk:URDFConverter:SlotToolbar", CommandBarTypeEnum.kRegularCommandBar, addInCLSIDString);
                    ...
                    //    //get the ribbon associated with part document
                        ...
                        partSketchRibbonTab = ribbonTabs.Add("URDF", "id_URDF", "{DB59D9A7-EE4C-434A-BB5A-F93E8866E872}");// ["id_TabSketch"];

                        //create a new panel with the tab
                        RibbonPanels ribbonPanels;
                        ribbonPanels = partSketchRibbonTab.RibbonPanels;

                        m_partSketchSlotRibbonPanel = ribbonPanels.Add("Slot", "Autodesk:URDFConverter:SlotRibbonPanel", "{DB59D9A7-EE4C-434A-BB5A-F93E8866E872}", "", false);
        ...
        private void UserInterfaceEvents_OnResetCommandBars(ObjectsEnumerator commandBars, NameValueMap context)
        {
            try
            {
                ...
                for (int commandBarCt = 1; commandBarCt <= commandBars.Count; commandBarCt++)
                {
                    ...
                    if (commandBar.InternalName == "Autodesk:URDFConverter:SlotToolbar")
                    {
                        //add comboboxes to toolbar
        ...
        private void UserInterfaceEvents_OnResetEnvironments(ObjectsEnumerator environments, NameValueMap context)
        {
            try
            {
                ...
                for (int environmentCt = 1; environmentCt <= environments.Count; environmentCt++)
                {
                    ...
                    {
                        //make this command bar accessible in the panel menu for the 2d sketch environment.
                        environment.PanelBar.CommandBarList.Add(m_inventorApplication.UserInterfaceManager.CommandBars["Autodesk:URDFConverter:SlotToolbar"]);
        ...
        private void UserInterfaceEvents_OnResetRibbonInterface(NameValueMap context)
        {
            try
            {
                ...
                m_partSketchSlotRibbonPanel = ribbonPanels.Add("Slot", "Autodesk:URDFConverter:SlotRibbonPanel",
